---
name: kernel-dev
description: Kernel-mode development for stealthy drivers, manual mappers, injectors, and rootkits (WDM/KMDF, APC injection, thread hijack, VAD, callback unhook, DKOM). Use when writing/modifying kernel code. Do NOT use for BYOVD against a third-party vulnerable driver (byovd) or usermode-only exploits (exploit-dev/pwn-chain).
---
