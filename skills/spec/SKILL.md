---
name: spec
description: "Use when creating/amending SPEC.md or recording bugs into section B ('write the spec', 'bug: ...')."
version: 1.0.0
license: MIT
metadata:
  ...
  upstream: C:\Users\Admin\.agents\skills\spec\SKILL.md
---

> Bundled with Unleash skills pack. Source: C:\Users\Admin\.agents\skills\spec\SKILL.md

# spec — spec mutator

Read `references/FORMAT.md` if not already loaded. Caveman skill applies to all writes here.
...
⊥ rewrite a section the handoff did not name. Sectioned ownership (see `references/FORMAT.md`).
...
- Caveman format per `references/FORMAT.md`.
