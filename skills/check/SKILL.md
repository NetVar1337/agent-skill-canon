---
name: check
description: "Use for read-only SPEC.md vs code drift detection ('check drift', 'check invariants')."
version: 1.0.0
license: MIT
metadata:
  ...
  category: imported
  upstream: C:\Users\Admin\.agents\skills\check\SKILL.md
---

> Bundled with Unleash skills pack. Source: C:\Users\Admin\.agents\skills\check\SKILL.md
