#!/usr/bin/env bash
# recon.sh — radare2 quick reconnaissance (basic binary info, sections, imports/exports, strings)
...
ensure_tool() {
    ...
    echo "INFO: $name not found, attempting to install..."
...
if [[ "$RUN_ANALYSIS" == "true" ]]; then
    echo ""
    echo "=== Functions and Entry Analysis ==="
