...
| **N** | IAT empty/very small + hand-rolled hash-resolved APIs | bp `GetProcAddress`/`Ldr*`; reverse-lookup the export table by hash; re-inject symbols; coordinate with the "clean IAT" iron law | `E-api-hash` | P0 |
