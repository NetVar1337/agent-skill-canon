...
$markdownLines = @(
    ...
    '- Routing entry: `SKILL.md` -> `routing.md` -> the corresponding sub-skill',
    '- Note: this table is auto-generated by `skills/scripts/refresh-tool-index.ps1` and is used by each Agent client for routing and tool path confirmation.',
    '- Attention: tool availability for MCP-only capabilities is computed separately from the runtime; `npx` only indicates the runtime condition for npm MCPs and cannot by itself make jshookmcp / reqable-mcp available or Ready.',
    '',
    '| Tool | Owning skill | Purpose | Available | Path | Version | Source | Script refs |',
    '|---|---|---|---|---|---|---|---|'
)
...
$markdownCapLines += ''
$markdownCapLines += '> ✓ = yes | ✗ = no | — = not applicable or not detected'
$markdownCapLines += ''
